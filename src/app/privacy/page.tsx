export const metadata = { title: "Privacy Policy", alternates: { canonical: "https://tinnitusguides.com/privacy" } };
...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-4">
      ...
      <p>Email: <a className="text-cyan-700 underline" href="mailto:privacy@tinnitusguides.com">privacy@tinnitusguides.com</a></p>
    </div>
  );
}
