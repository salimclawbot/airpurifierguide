export const metadata = { title: "Affiliate Disclosure", alternates: { canonical: "https://jawpainguide.com/affiliate-disclosure" } };
...
export default function AffiliateDisclosurePage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-4">
      ...
      <p>Email: <a className="text-cyan-700 underline" href="mailto:editorial@jawpainguide.com">editorial@jawpainguide.com</a></p>
    </div>
  );
}
